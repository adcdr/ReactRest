...
defaultClient = __webpack_require__(24);
mixin = __webpack_require__(9);
responsePromise = __webpack_require__(15);
...
registry.register('application/hal', __webpack_require__(28));
registry.register('application/json', __webpack_require__(58));
registry.register('application/x-www-form-urlencoded', __webpack_require__(29));
...
pathPrefix = __webpack_require__(51);
template = __webpack_require__(53);
find = __webpack_require__(56);
lazyPromise = __webpack_require__(57);
responsePromise = __webpack_require__(15);
...
*/
var aa=__webpack_require__(11),l=__webpack_require__(18),B=__webpack_require__(7),C=__webpack_require__(4),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(8);
...
var rest = __webpack_require__(47);
var defaultRequest = __webpack_require__(49);
var mime = __webpack_require__(50);
var errorCode = __webpack_require__(61);
var baseRegistry = __webpack_require__(27);

var registry = baseRegistry.child();

registry.register('application/hal+json', __webpack_require__(28));
...
interceptor = __webpack_require__(5);
mixinUtil = __webpack_require__(9);
...
interceptor = __webpack_require__(5);
mime = __webpack_require__(26);
registry = __webpack_require__(27);
attempt = __webpack_require__(30);
...
interceptor = __webpack_require__(5);
UrlBuilder = __webpack_require__(52);
...
mixin = __webpack_require__(9);
xWWWFormURLEncoder = __webpack_require__(29);
...
interceptor = __webpack_require__(5);
uriTemplate = __webpack_require__(54);
mixin = __webpack_require__(9);
...
uriEncoder = __webpack_require__(55);
...
var attempt = __webpack_require__(30);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            client({ method: 'GET', path: '/getgame?id=1' }).then(function (response) {
                _this2.setState({ game: response.entity });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return React.createElement(Game, { game: this.state.game });
        }
    }]);
            ...
            if (this.props && this.props.game && this.props.game.board && this.props.game.board.cells) {
                return React.createElement(
                    ...
                    React.createElement(
                        'tbody',
                        null,
                        React.createElement(Rows, { cells: this.props.game.board.cells })
                    )
                );
            } else {
                return React.createElement(
