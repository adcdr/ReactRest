...
defaultClient = __webpack_require__(18);
mixin = __webpack_require__(5);
responsePromise = __webpack_require__(10);
...
registry.register('application/hal', __webpack_require__(22));
registry.register('application/json', __webpack_require__(49));
registry.register('application/x-www-form-urlencoded', __webpack_require__(23));
registry.register('multipart/form-data', __webpack_require__(50));
registry.register('text/plain', __webpack_require__(51));
...
pathPrefix = __webpack_require__(42);
template = __webpack_require__(44);
find = __webpack_require__(47);
lazyPromise = __webpack_require__(48);
responsePromise = __webpack_require__(10);
...
*/
var aa=__webpack_require__(6),l=__webpack_require__(12),B=__webpack_require__(3),C=__webpack_require__(1),ba=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ia=__webpack_require__(17),D=__webpack_require__(4);
...
var errorCode = __webpack_require__(52);
var baseRegistry = __webpack_require__(21);

var registry = baseRegistry.child();

registry.register('application/hal+json', __webpack_require__(22));
...
normalizeHeaderName = __webpack_require__(19);
responsePromise = __webpack_require__(10);
client = __webpack_require__(9);
...
mixinUtil = __webpack_require__(5);
...
interceptor = __webpack_require__(2);
mime = __webpack_require__(20);
registry = __webpack_require__(21);
...
interceptor = __webpack_require__(2);
UrlBuilder = __webpack_require__(43);
...
interceptor = __webpack_require__(2);
uriTemplate = __webpack_require__(45);
mixin = __webpack_require__(5);
...
uriEncoder = __webpack_require__(46);
...
var Lobby = function (_React$Component) {
    ...
    _createClass(Lobby, [{
        ...
        value: function componentDidMount() {
            ...
            client({ method: 'GET', path: '/players' }).then(function (response) {
                _this2.setState({ players: response.entity });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            return React.createElement(Players, { game: this.state.players });
        }
    }]);
...
var Players = function (_React$Component2) {
            ...
            if (this.props && this.props.players) {
                return React.createElement(
                    ...
                    React.createElement(
                        'tbody',
                        null,
                        React.createElement(Rows, { cells: this.props.players })
                    )
                );
            } else {
                return React.createElement(
...
ReactDOM.render(React.createElement(Lobby, null), document.getElementById('lobby'));
